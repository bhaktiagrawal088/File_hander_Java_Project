...
public class dataDAO {
    ...
    public static int hideFile(Data file) throws SQLException, FileNotFoundException, IOException {
        ...
        PreparedStatement ps = connection
                .prepareStatement("insert into data (name, path, email, bin_data) values(? , ? , ? , ? )");
        ...
        fr.close();
        f.delete();
        return ans; // return the number of row affected by this operation
    ...
    public static void unhide(int id) throws SQLException, IOException {
        ...
        ps.setInt(1, id);
        ps.executeUpdate();
        System.out.println("File is successfully unhide ");
    }
}
